...
// horizontal full rainbow. The dodge brightens the rainbow where the fade is light,
// so it reads dark at the floor and blooms into saturated rainbow toward the top.
// Rises on a scaleY reveal.
